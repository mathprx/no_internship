...
def main(shared_path, hybrid_path_h0, save_path):
    print('Starting program')
    # Load the baseline physics simulation datasets
    ds_mmf_ref = xr.open_dataset(f'{shared_path}/h0/1year/mmf_ref/mmf_ref.eam.h0.0003.nc')
    ds_mmf_a = xr.open_dataset(f'{shared_path}/h0/1year/mmf_a/mmf_a.eam.h0.0003.nc')
    ds_mmf_b = xr.open_dataset(f'{shared_path}/h0/1year/mmf_b/mmf_b.eam.h0.0003.nc')
    ds_mmf_c = xr.open_dataset(f'{shared_path}/h0/1year/mmf_c/mmf_c.eam.h0.0003.nc')
    ds_nn = xr.open_mfdataset(f'{hybrid_path_h0}/*.eam.h0.0003-*.nc', engine='netcdf4')
    ...
    plt.savefig(f'{save_path}/downstream_monthly_rmse.jpeg')
    # plt.show()
...
if __name__ == "__main__":
    ...
    main(args.shared_path, args.hybrid_path_h0, args.save_path)